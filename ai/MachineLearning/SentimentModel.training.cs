...
namespace MachineLearning
{
    ...
    {
        public const string RetrainFilePath =  @"D:\git\dotnet-dev-2025\ai\MachineLearning\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.15603903F,L2Regularization=6.7088943F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
